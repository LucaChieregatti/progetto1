        ...
        return(
            <ChakraProvider>
                <Box marginTop= '2em'
                    ...
                    <RadioGroup>
                    <VStack>
                        <Text color='black' fontSize='30px' >6. Come valuterebbe i seguenti servizi della nostra boutique online?</Text>
                        <Text color='black' fontSize='24px' >Spedizione & Packaging</Text>
